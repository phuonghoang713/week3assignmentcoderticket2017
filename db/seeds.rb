...
e = Event.create({
  ...
  hero_image_url: 'https://tkbvn-tokyo.s3.amazonaws.com/Upload/agenda/2015/12/14/57EEE9.jpg',
...
e = Event.create({
  ...
  hero_image_url: 'https://tkbvn-tokyo.s3.amazonaws.com/Upload/eventcover/2015/12/11/C68636.jpg',
  extended_html_description: <<-DESC
  ...
  <p style="text-align:justify"><img src="https://tkbvn-tokyo.s3.amazonaws.com/Upload/agenda/2015/12/14/57EEE9.jpg" /></p>
...
e = Event.create({
  ...
  venue: gap,
  category: Category.find_by(name: 'Entertainment'),
  hero_image_url: 'https://tkbvn-tokyo.s3.amazonaws.com/Upload/eventcover/2015/12/12/78534E.jpg',
  extended_html_description: <<-DESC
         <p>
